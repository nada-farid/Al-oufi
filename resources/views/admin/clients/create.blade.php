    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_number') ? 'is-invalid' : '' }}" type="text" name="tax_number" id="tax_number" value="{{ old('tax_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_person_2') ? 'is-invalid' : '' }}" type="text" name="contact_person_2" id="contact_person_2" value="{{ old('contact_person_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_tel') ? 'is-invalid' : '' }}" type="text" name="home_tel" id="home_tel" value="{{ old('home_tel', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_number_1') ? 'is-invalid' : '' }}" type="text" name="mobile_number_1" id="mobile_number_1" value="{{ old('mobile_number_1', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_number_2') ? 'is-invalid' : '' }}" type="text" name="mobile_number_2" id="mobile_number_2" value="{{ old('mobile_number_2', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('fees') ? 'is-invalid' : '' }}" name="fees[]" id="fees" multiple required>
                    @foreach($fees as $id => $fee)
                        <option value="{{ $id }}" {{ in_array($id, old('fees', [])) ? 'selected' : '' }}>{{ $fee }}</option>
                    @endforeach
                </select>
                @if($errors->has('fees'))
                    <div class="invalid-feedback">
