                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('client_no') ? 'is-invalid' : '' }}" type="text"
                                name="client_no" id="client_no"  disabled    value="{{$client->id }}" />
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('tel_1') ? 'is-invalid' : '' }}" type="text"
                                name="tel_1" id="tel_1"  required value="{{ old('tel_1', $client->tel_1) }}">
                            @if ($errors->has('tel_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tel_1') }}
                                </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('tel_2') ? 'is-invalid' : '' }}" type="text"
                                name="tel_2" id="tel_2" value="{{ old('tel_2', $client->tel_2) }}">
                            @if ($errors->has('tel_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tel_2') }}
                                </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text"
                                name="address" id="address" value="{{ old('address', $client->address) }}" required>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text"
                                name="fax" id="fax" value="{{ old('fax', $client->fax) }}">
                            @if ($errors->has('fax'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fax') }}
                                </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('contact_person_2') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('contact_person_2', $client->contact_person_2) }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}"
                                type="text" name="bank_name" id="bank_name" value="{{ old('bank_name',$client->bank_name) }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('home_tel') ? 'is-invalid' : '' }}"
                                type="text" name="home_tel" id="home_tel" value="{{ old('home_tel', $client->home_tel) }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('iban') ? 'is-invalid' : '' }}" type="text"
                                name="iban" id="iban" value="{{ old('iban',$client->iban) }}">
                            @if ($errors->has('iban'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('iban') }}
                                </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('mobile_number_1') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('mobile_number_1',$client->mobile_number_1) }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('mobile_number_2') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('mobile_number_2',$client->mobile_number_2) }}">
                    ...
                    <div class="form-group ">
                        ...
                        <input class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks"
                            id="remarks" value="{{ old('remarks',$client->remarks)}}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control date {{ $errors->has('from') ? 'is-invalid' : '' }}"
                                    type="text" name="from" id="from" value="{{ old('from',$client->from) }}" required>
                                @if ($errors->has('from'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('from') }}
                                    </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control date {{ $errors->has('to') ? 'is-invalid' : '' }}"
                                    type="text" name="to" id="to" value="{{ old('to',$client->to) }}" required>
                                @if ($errors->has('to'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('to') }}
                                    </div>
